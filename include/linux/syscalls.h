...
//USAC
//Esto no es explicitamente necesario en kernels actuales debido a que se auto generan con el macro SYSCALL_DEFINEn
//asmlinkage long sys_matus_get_realtime(void);
//asmlinkage long sys_matus_track_syscall_usage(struct syscall_usage *statistics);
